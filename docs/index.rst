...
boto3-client-cache, it should be noted, is also a critical dependency for `boto3-refresh-session <https://github.com/michaelthomasletts/boto3-refresh-session>`_.
